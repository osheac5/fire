...
public class GLCube {
	...
	public float yscale = 6.5f;
	public float zscale = 4;
	// a cube is made of 12 triangles
	private float vertices [] = {
			-1*xscale, 1*yscale, -1*zscale,  // point 0 (top right front)
			-1*xscale, -1*yscale, -1*zscale, // point 1 (bottom right front)
	...
	private float rgbaVals [] = {
			1, 0, 0, 1, 		// Color of first vertex
			1, 0, 0, 1, 		// Color of second vertex
			1, 0, 0, 1,			// Color of third vertex
			1, 0, 0, 1,			// Color of forth Vertex
			1, 0, 0, 1,			// Color of fifth Vertex
			1, 0, 0, 1,			// Color of sixth Vertex
			1, 0, 0, 1,			// Color of seventh Vertex
			1, 0, 0, 1,			// Color of eighth Vertex
			1, 0, 0, 1,			// Color of ninth Vertex
			1, 0, 0, 1,			// Color of tenth Vertex
			1, 0, 0, 1,			// Color of eleventh Vertex
			1, 0, 0, 1,			// Color of twelfth Vertex
			1, 0, 0, 1,			// Color of 13th Vertex
			1, 0, 0, 1,			// Color of 14th Vertex
			1, 0, 0, 1,			// Color of 15th Vertex
			1, 0, 0, 1,			// Color of 16th Vertex
			1, 0, 0, 1,			// Color of 17th Vertex
			1, 0, 0, 1			// Color of 18th Vertex
	};
	...
	public void loadGLTexture(GL10 gl, Context context) {
		Bitmap bitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.brickwork);
